...
#define OK_BUTTON_Pin GPIO_PIN_12
#define OK_BUTTON_GPIO_Port GPIOB
#define OK_BUTTON_EXTI_IRQn EXTI15_10_IRQn
#define KO_BUTTON_Pin GPIO_PIN_13
#define KO_BUTTON_GPIO_Port GPIOB
#define KO_BUTTON_EXTI_IRQn EXTI15_10_IRQn
