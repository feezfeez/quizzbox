...
#define YELLOW_BUZZ_BP_Pin GPIO_PIN_2
#define YELLOW_BUZZ_BP_GPIO_Port GPIOA
#define YELLOW_BUZZ_BP_EXTI_IRQn EXTI2_TSC_IRQn
#define GREEN_BUZZ_BP_Pin GPIO_PIN_3
#define GREEN_BUZZ_BP_GPIO_Port GPIOA
#define GREEN_BUZZ_BP_EXTI_IRQn EXTI3_IRQn
...
#define START_BP_Pin GPIO_PIN_11
#define START_BP_GPIO_Port GPIOB
#define START_BP_EXTI_IRQn EXTI15_10_IRQn
